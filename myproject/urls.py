...
urlpatterns = [
    ...
    path(
        "conversion/", include("conversion.urls")
    ...
    path(
        "loans/collateral/", include("loans_collateral.urls")
    ...
    path(
        "loan-bridge/", include("loan_reconciliation_bridge.urls")
    ),  # Loan reconciliation bridge
    path(
        "loan-reports/", include("loan_report.urls")
    ),  # Advanced loan reporting and analytics
    ...
    path(
        "loan-schedule-prototype/",
        loan_schedule_prototype_view,
        name="loan_schedule_prototype",
    ),
    # Template testing routes - include the core URLs
    path(
        "", include("core.urls")
    ),  # This will make /dashboard/, /test-404/, etc. work directly
]
